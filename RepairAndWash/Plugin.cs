...
//
//
// Last Modified: 01:03:2017 / 01:27
// Creation: 01:03:2017
...
namespace RepairAndWash
{
	...
	public static class Plugin
	{
		...
		private static void OnKeyDown(Global.Enums.Action action)
		{
			...
			// TODO : Export into Separate Methodes

			// Execute a Method based on the Action Param
		...
		{
			// All Rage Plugins run inside a While loop - To not use all of the CPU time you have to Yield to let other Plugins and GTA have some Processing Time
			while (true)
			{
				// Stops the GameFibre for a Brief Second
				GameFiber.Yield();

				// Check if a Key is Pressed and if so Execute the Method the Key is meant to do.
